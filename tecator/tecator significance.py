...
# ==============================================================
# 5. Determine best preprocessing for each model
# ==============================================================
...
for sheet in all_preprocessing_sheets:
    ...
    rmse_pfn = evaluate_pfn(X_train, y_train, X_test, y_test, seed=42)
    rmse_plsr   = evaluate_plsr  (X_train, y_train, X_test, y_test, seed=42)
    rmse_svr    = evaluate_svr   (X_train, y_train, X_test, y_test, seed=42)

    if rmse_pfn < best_rmse["NIRSpecPFN"]:
        best_rmse["NIRSpecPFN"] = rmse_pfn
...
for i in range(n_bootstrap):
    ...
    rmse = evaluate_pfn(X_boot, y_boot, X_test, y_test, seed=i)
