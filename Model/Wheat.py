...
# ==============================================================
file_path = r"D:\A\CSU\NIRdatasets\wheat\A1_processed.xlsx"
...
output_dir = os.path.join(os.path.dirname(__file__), f"wheat_{target_property}_results")
plot_dir = os.path.join(output_dir, f"wheat_{target_property}_plots")
excel_output_path = os.path.join(output_dir, f"wheat_{target_property}_metrics.xlsx")
