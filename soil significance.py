...
output_dir = os.path.join(os.path.dirname(__file__), f"soil_{target_property}_significance_results")
...
X_train_idx, X_test_idx, y_train, y_test = ks_split(X_with_idx, y_ref, test_size=0.25)
...
excel_path = os.path.join(output_dir, f"soil_{target_property}_bootstrap_rmse_results.xlsx")
